...
function Hero() {
    ...
    const initializeTagCloud = useCallback(() => {
        ...
        const texts = [
            'Frontend', 'Generative AI', 'Mobile App', 'Web App', 'FinTech',
            'SQL', 'NoSQL', 'Cyber Security', 'FastAPI', 'Graph DB', "Big Data",
                ...
                <MotionFlex direction="column" maxW="80%" variants={itemVariants}>
                    ...
                    >
                        <Typewriter
                            options={{
                                strings: [
                                    "Finalist of International AI Hackathon",
                                    "Winner of National AI Competition 2025",
                                    "Problem Solver with Agentic AI",
                                ],
                                autoStart: true,
                                loop: true,
                                deleteSpeed: 15,
